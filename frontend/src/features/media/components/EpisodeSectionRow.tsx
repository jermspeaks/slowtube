...
interface EpisodeSectionRowProps {
  title: string
  description: string
  episodes: Episode[]
  viewAllLink: string
...
function EpisodeSectionRow({ title, description, episodes, viewAllLink, onUpdate }: EpisodeSectionRowProps) {
  ...
  return (
    <div className="mb-8">
      ...
      {/* Horizontal Scrollable Episode Cards */}
...
export default EpisodeSectionRow
